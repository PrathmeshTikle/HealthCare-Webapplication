...
SECRET_KEY = 'django-insecure-*#^w_2mg6^#^trgar&=v-8k(-tp-go5gx26fdhff($c5-+-php'
...
EMAIL_HOST_USER = 'ashishmewada1435@gmail.com'  # Your SMTP username
EMAIL_HOST_PASSWORD = 'cewgdtdxzmihzdnr'  # Your SMTP password


LOGIN_REDIRECT_URL = 'accounts/loginuser'